...
describe("Matrix addition test", function () {
    this.timeout(100000000);

    it("should add two 2 by 3 matrices", async () => {
        const circuit = await wasm_tester(path.join(__dirname, "circuits", "matAdd_test.circom"));
